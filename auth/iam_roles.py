...
Usage:
    python auth/iam_roles.py --profile test-account [--region ap-southeast-2]
    python auth/iam_roles.py --profile test-account --teardown  # Remove all roles
...
def main(profile, region, do_teardown):
    ...
    if not identity_pool_id:
        raise click.ClickException(
            ...
            'Run: python auth/cognito_setup.py first'
        )
