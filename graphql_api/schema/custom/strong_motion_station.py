...
class StrongMotionStationFields():
    ...
    created = graphene.DateTime(description="When the SMS record was created", )
    updated = graphene.DateTime(description="When SMS record was updated", )
    ...
    bedrock_encountered = graphene.Boolean(description="Indicate whether subsurface investigations have encountered bedrock")
