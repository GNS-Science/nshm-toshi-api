...
- **Compute env, job queue, ECR repos, and `nshm-runzi-*` buckets** are manual/external — no IaC in either repo (only the IAM *permissions* to use/manage them exist here).
