...
### Added
 ...
 - `search.NOT_INDEXED`: classes deliberately kept out of the index. `OpenquakeHazardConfig` (2.19M objects, absent since the index was rebuilt in May 2024) is excluded from both the live write path and the backfill.
